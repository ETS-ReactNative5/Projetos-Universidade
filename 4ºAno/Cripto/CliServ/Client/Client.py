...
# Keystore do cliente
cl_p12_bytes = open('Client/client.p12', 'rb').read()
...
class Client:
    ...
    def process(self, msg = b""):
        ...
        #   certificado do servidor
            ...
            # Os primeiros 625 bytes estão reservados para a chave do servidor, os 512
            #   bytes seguintes para a sua assinatura e os restantes para o seu
            #   certificado
            sv_key_public_dh_bytes = msg[:625]
            sv_signature = msg[625:1137] # 625 + 512 = 1137
            sv_cert_bytes = msg[1137:]
            ...
            sv_cert_subject = sv_cert.subject.rfc4514_string()
            sv_cert_issuer = sv_cert.issuer.rfc4514_string()
            
            print('  (Subject: ' + sv_cert_subject + ')')
            print('  (Issuer:  ' + sv_cert_issuer + ')')
